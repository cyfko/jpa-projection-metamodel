...
public interface PersistenceRegistryProvider {
     ...
     * <p>
     * The returned map is unmodifiable and contains all {@code jakarta.persistence.Embeddable} processed
     * by the annotation processor at compile time. The outer map uses embeddable
     * classes as keys, and the inner maps use field names as keys.
     * </p>
     *
     * @return an unmodifiable map from {@code jakarta.persistence.Embeddable} class to field metadata map
     */
